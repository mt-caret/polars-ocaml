    ...
    fn check_div() {
        ...
        check(
            ...
            expect![[r#"
                shape: (10, 5)
                ┌────────────┬───────┬───────┬───────┬───────────┐
                │ station    ┆ day_1 ┆ day_2 ┆ day_3 ┆ temps_ran │
                │ ---        ┆ ---   ┆ ---   ┆ ---   ┆ k         │
                │ str        ┆ i32   ┆ i32   ┆ i32   ┆ ---       │
                │            ┆       ┆       ┆       ┆ list[f64] │
                ╞════════════╪═══════╪═══════╪═══════╪═══════════╡
                │ Station_1  ┆ 17    ┆ 15    ┆ 16    ┆ [0.33,    │
                │            ┆       ┆       ┆       ┆ 1.0,      │
                │            ┆       ┆       ┆       ┆ 0.67]     │
                │ Station_2  ┆ 11    ┆ 11    ┆ 15    ┆ [0.67,    │
                │            ┆       ┆       ┆       ┆ 0.67,     │
                │            ┆       ┆       ┆       ┆ 0.33]     │
                │ Station_3  ┆ 8     ┆ 10    ┆ 24    ┆ [1.0,     │
                │            ┆       ┆       ┆       ┆ 0.67,     │
                │            ┆       ┆       ┆       ┆ 0.33]     │
                │ Station_4  ┆ 22    ┆ 8     ┆ 24    ┆ [0.67,    │
                │            ┆       ┆       ┆       ┆ 1.0,      │
                │            ┆       ┆       ┆       ┆ 0.33]     │
                │ …          ┆ …     ┆ …     ┆ …     ┆ …         │
                │ Station_7  ┆ 20    ┆ 18    ┆ 19    ┆ [0.33,    │
                │            ┆       ┆       ┆       ┆ 1.0,      │
                │            ┆       ┆       ┆       ┆ 0.67]     │
                │ Station_8  ┆ 8     ┆ 21    ┆ 23    ┆ [1.0,     │
                │            ┆       ┆       ┆       ┆ 0.67,     │
                │            ┆       ┆       ┆       ┆ 0.33]     │
                │ Station_9  ┆ 8     ┆ 15    ┆ 16    ┆ [1.0,     │
                │            ┆       ┆       ┆       ┆ 0.67,     │
                │            ┆       ┆       ┆       ┆ 0.33]     │
                │ Station_10 ┆ 17    ┆ 13    ┆ 10    ┆ [0.33,    │
                │            ┆       ┆       ┆       ┆ 0.67,     │
                │            ┆       ┆       ┆       ┆ 1.0]      │
                └────────────┴───────┴───────┴───────┴───────────┘"#]],
        );
